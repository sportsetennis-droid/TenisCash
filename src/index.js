...
const qrOffersRoutes = require('./routes/qrOffers');
...
const storeRadioRoutes = require('./routes/storeRadio');
...
app.use('/api/admin/qr-offers', qrOffersRoutes.adminRouter);
app.use(qrOffersRoutes.publicRouter);
