...
const labelsRoutes = require('./modules/labels/routes/labels');
const fiscalRoutes = require('./routes/fiscal');
const curationRoutes = require('./modules/curadoria-vitrine/routes/curation');
...
const activitiesRoutes = require('./modules/apex/routes/activities');
const coachRoutes = require('./modules/apex/routes/coach');
