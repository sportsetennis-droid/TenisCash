// Evidencias privadas do ciclo de comissao (fotos e videos de clientes).
// Arquivos ficam no volume; o acesso acontece somente por rota autenticada.
...
const DIR = process.env.COMMISSION_EVIDENCE_DIR || (IS_PROD
  ? '/data/commission-evidence'
  : path.join(__dirname, '../../tmp/commission-evidence'));
