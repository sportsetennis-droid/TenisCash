...
assert.equal(row.totalAt1Percent, 500);
assert.equal(row.totalAt2And4Percent, 1400);
assert.equal(calc([sale(10000, 2000)]).totalAt2And4Percent, 240);
assert.equal(calc([sale(10000, 0)]).totalAt2And4Percent, 200);
assert.equal(calc([sale(10000, 10000)]).totalAt2And4Percent, 400);
